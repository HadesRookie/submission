package com.graduation.submission.controller.error;


import com.graduation.submission.utils.ExceptionEnum;
import com.graduation.submission.utils.Result;
...
/**
 * @项目名称：submission
 * @包名：com.graduation.submission.controller.error
 * @类描述：普通请求统一使用error页面处理，异步请求，返回统一的Result(status,message,data)对象
 * @创建人：LJL
 * @创建时间：2019-03-06 17:00
 * @version：V1.0
 */
@Controller
