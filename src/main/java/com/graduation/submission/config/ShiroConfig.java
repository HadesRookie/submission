...
import com.graduation.submission.filter.KickoutSessionFilter;
import com.graduation.submission.shiro.RetryLimitHashedCredentialsMatcher;
...
//		// 配置不会被拦截的链接 从上向下顺序判断
        ...
        filterChainDefinitionMap.put("/user/updateUserInfo", "anon");
