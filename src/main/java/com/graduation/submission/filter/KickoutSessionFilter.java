package com.graduation.submission.filter;
...
import com.graduation.submission.utils.ShiroFilterUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
	...
	protected boolean onAccessDenied(ServletRequest request,
		...
		try {
			...
			logger.error(
					"控制用户在线数量【submission-admin-->KickoutSessionFilter.onAccessDenied】异常！",
					e);
	...
	public static void out(ServletResponse response, ResponseResult result){
		...
		try {
			...
			logger.error("用户在线数量限制【manager-->KickoutSessionFilter.out】响应json信息成功");
		} catch (Exception e) {
